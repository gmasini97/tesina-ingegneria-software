...
\begin{center}
    \srseitable{01}{Database}{Gerarchia dispositivi}{L'applicazione riceve in formato JSON la lista di dispositivi, gruppi e la loro organizzazione gerarchica.}{Consultare \nameref{sec:appendice:ei01} in appendice per un esempio di JSON}{Input}
...
\begin{figure}[H]
    ...
    \label{fig:usecase}
\end{figure}
\subsubsection{Class diagram e design pattern}
...
\subsection{Formato dati interfacce}
\subsubsection{EI01}
\label{sec:appendice:ei01}
\textit{L'id ``00'' identifica la radice}
